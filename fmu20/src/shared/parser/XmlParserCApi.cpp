...
// returns one of exact, approx, calculated.
// If value is missing, the default value is defined according to section 2.2.7 of 
// https://svn.modelica.org/fmi/branches/public/specifications/FMI_for_ModelExchange_and_CoSimulation_v2.0_RC2.pdf
Enu getInitial(ScalarVariable *sv) {
	return (Enu)sv->getInitial();
}
